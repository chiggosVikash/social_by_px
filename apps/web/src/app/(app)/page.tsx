...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Card className="group overflow-hidden border border-border/50 bg-card hover:bg-accent/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-primary/30 relative">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              {status !== "Not started" && (
                <Badge variant={isCompleted ? "default" : "outline"} className={isWorking ? "animate-pulse" : ""}>
                  {status}
                </Badge>
              )}
            </div>
        ...
        <div className="pt-4 mt-2 border-t border-border/40 space-y-2">
          ...
          {isCompleted && (
            <PreviewModal projectId={project.id}>
              <Button className="w-full justify-between rounded-lg font-medium" variant="outline">
                <span className="flex items-center">
                  <Eye className="mr-2 h-4 w-4" /> Preview Results
                </span>
